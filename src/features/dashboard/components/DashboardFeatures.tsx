  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 animate-fade-in delay-100">
      {features.map((feature, index) => (
        ...
        >
          <Card
            className={`p-2 bg-gray-200 dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-700 hover:border-neutral-400 dark:hover:border-neutral-600 transition-all duration-300 h-full cursor-default`}
          >
            <div className="flex  gap-2">
              ...
              <div>
                <h3 className="text-neutral-700 dark:text-neutral-300 font-medium text-sm mb-0.5 group-hover:text-blue-500 dark:group-hover:text-blue-400 transition-colors">
                  {feature.title}
                </h3>
